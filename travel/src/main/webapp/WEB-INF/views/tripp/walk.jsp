  ...
  window.onload = function() { 
		...
		//		 serviceKey : 'HPG/iUcz/t/Q8HAFjrKL9sP2JYkLOIIgbnEzvj9enzRYy+jXWDidxABqUgD85CcU/UhqdtU2SPY+tq97nfbRxw==',  //decoding
		   ...
		   .then(( obj ) => {
			   ...
			   let  arr =  obj.data.getWalkingKr.item;
			   console.log(arr);
			   let  html  = '';
			   arr.forEach( (row) => {	
				  // alert(JSON.stringify(row))
				  console.log(row.MAIN_TITLE)
				  const walkInformUrl = '/WalkView?UC_SEQ=' + row.UC_SEQ + '&MAIN_TITLE=' + row.MAIN_TITLE;
				   /*html += '<ul>';				   
	...
	<div id="content">
		<div style="position: relative; width: 100%; height: 400px;">
			...
			<div
				...
				<h1 style="color: #fff; font-size: 50px;">부산 도보여행</h1>
				<h2 style="color: black; font-size: 22px;">도보로 즐겁게 여행할 수 있습니다!.</h2>
			</div>
		</div>
	</div>
	<!-- body end -->
