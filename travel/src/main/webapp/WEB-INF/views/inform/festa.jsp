  ...
  window.onload = function() {
		...
		//		 serviceKey : 'HPG/iUcz/t/Q8HAFjrKL9sP2JYkLOIIgbnEzvj9enzRYy+jXWDidxABqUgD85CcU/UhqdtU2SPY+tq97nfbRxw==',  //decoding
		   ...
		   .then(( obj ) => {
			   ...
			   let  arr =  obj.data.getFestivalKr.item;
			   console.log(arr);
			   let  html  = '';
			   arr.forEach( (row) => {	
				  // alert(JSON.stringify(row))
				  console.log(row.MAIN_TITLE)
				  const festaInformUrl = '/FestaView?UC_SEQ=' + row.UC_SEQ + '&MAIN_TITLE=' + row.MAIN_TITLE;
				   /*html += '<ul>';				   
