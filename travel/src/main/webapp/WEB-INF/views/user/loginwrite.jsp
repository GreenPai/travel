  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form id="loginForm" action="/Login/Form" method="POST" class="validation-form" novalidate >
          <div class="row">
          ...
          <div class="mb-3">
            <label for="birth">생년월일<span class="text-muted">&nbsp;(필수 아님)</span></label>
            <input type="text" class="form-control" id="birth" placeholder="상세주소를 입력해주세요.">
          </div>
