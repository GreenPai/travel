...
<section>
	...
	var positions = [
	    ...
	    {
	        content: '<div>책방골목<br><img src="/img/map/bookstreet.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(35.098423, 129.010103)
	    },
	    {
	        content: '<div>거제바람언덕<br><img src="/img/map/bada.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(34.745037, 128.663276)
	    },
	    {
	        content: '<div>아홉산숲<br><img src="/img/map/ninef.jpg" sytle="width:352px; height:220px;"></div>',
	    ...
	    {
	        content: '<div>해운대 수목원<br><img src="/img/map/sumok.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(35.230057, 129.132772)
	    },
	    {
	        content: '<div>F1963<br><img src="/img/map/F1963.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(35.176967, 129.114986)
	    },
	    {
	        content: '<div>부산항힐링야영장<br><img src="/img/map/campsite.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(35.112239, 129.050362)
	    },
	    {
	        content: '<div>부산아시아드경기장<br><img src="/img/map/asiad.jpg" sytle="width:352px; height:220px;"></div>',
	        latlng: new kakao.maps.LatLng(35.190228, 129.058223)
	    },
	    {
	        content: '<div>북천 야외전시관<br><img src="/img/map/bukchen.jpg" sytle="width:352px; height:220px;"></div>',
